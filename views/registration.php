...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <a href="index.php" class="mx-auto mt-3" style="max-width: max-content;"><img class="logo-img "
                    src="./public/image/browser.png" alt="logo"></a>
            <div class="card-header text-center flex-direction-column pt-2">
                <h3>新規登録</h3>
                <p class="mb-2">アカウントをお持ちの方は<a href="index.php?action=login"
                        class="footer-link pb-1 text-success">ログイン</a></p>
                <?php
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <div class="form-group d-flex justify-content-between">
                        <div class="form-group">
                            <input
                                class="form-control form-control-lg <?php echo (!empty($lastName_err)) ? 'is-invalid' : ''; ?>"
                                value="<?php echo $lastName; ?>" id="lastName" name="lastName" type="text"
                                placeholder="性">
                        ...
                        <div class="form-group ml-2">
                            <input
                                class="form-control form-control-lg <?php echo (!empty($firstName_err)) ? 'is-invalid' : ''; ?>"
                                value="<?php echo $firstName; ?>" id="firstName" name="firstName" type="text"
                                placeholder="名">
                            <span class="invalid-feedback">
