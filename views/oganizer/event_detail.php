        ...
        style="background-color:#d3e4ed;">
            <form id="eventForm" >
                ...
                <div class="align-labels">
                    ...
                    <div class="form-group">
                        <input type="text" value="<?php echo $event['event_name'];  ?>" class="form-control" id="eventName" required>
                    </div>
                </div>
                ...
                <div class="align-labels">
                    ...
                    <div class="form-group">
                        <input type="text" value="<?php echo $event['event_venue'];  ?>" class="form-control" id="venue" required>
                    </div>
                </div>
                ...
                <div class="align-labels">
                    ...
                    <div class="form-group">
                        <input type="text" value="<?php echo $event['event_address'];?>" class="form-control" id="address" required>
                    </div>
                </div>
                ...
                <div class="align-labels">
                    ...
                    <div class="form-group">
                        <input type="url" value="<?php echo $event['event_url'];  ?>" class="form-control" id="url" required>
                    </div>
                </div>
                ...
                <div class="align-labels">
                    ...
                    <div class="form-group">
                        <input type="number" value="<?php echo $event['participation_fee'];  ?>"  class="form-control" id="participationFee" required>
                    </div>
                </div>
                ...
                <div class="align-labels">
                    ...
                    <div class="form-group">
                        <input type="number" value="<?php echo $event['num_participants'];  ?>" class="form-control" id="numParticipants" required>
                    </div>
                </div>
                ...
                <div class="align-labels">
                    ...
                    <div class="form-group">
                        <input type="text" value="<?php echo $event['matching_restrictions'];  ?>"  class="form-control" id="matchingRestrictions">
                    </div>
                </div>
                <div class="tag-container" id="tagContainer">
                    ...
                    <div class="tag-component">
                        <span class="tag-text"><?php echo $tag ?></span>
                ...
                <div class="align-labels">
                    ...
                    <div class="form-group">
                        <textarea  class="form-control" id="content" rows="4" required><?php echo $event['content'];?></textarea>
                    </div>
                </div>
                <div class="align-labels d-flex   align-items-center">
                    ...
                    <div class="row  p-1">
                        <div class="col-sm-7 "> 
                            <input type="text" value="<?php echo $event['event_url'];?>" id="attender_url" style="width:120%" disabled>
                        </div>
                        <div class="col-sm-5 ">
