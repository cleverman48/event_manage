                ...
                <div class="col-lg-5 p-1">
                    <div class="card mb-1">
                        <div class="card-body text-center">
                            <img src="<?php echo $attender['avatar']; ?>" alt="avatar" class="rounded-circle img-fluid"
                                style="width: 150px;">
                            <div class="row">
                                <div class="col-8">
                    ...
                    <div class="card mb-1">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">
                                        <?php echo $attender['lastname'].' '.$attender['firstname']; ?>
                                    </p>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <a href="" class="mb-0"><i
                                            class="fab <?php echo sns2icon($attender['sns']); ?> fa-lg">
                                        </i>
                                    </a>
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="card mb-4 mb-md-0">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="index.php?action=attender_list&event=<?php echo $event_id ;?>" class="btn btn-success mt-2 mr-4">確認</a>
                                    </div>
                                </div>
                            </div>
                        </div>
