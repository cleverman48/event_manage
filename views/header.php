        ...
        <div class="" id="navbarSupportedContent">          
            <ul class="d-flex pl-0 mb-0 list-unstyled ml-auto navbar-right-top">        
                <div class="head_bt_pan mr-3 d-flex align-items-center">
                    <a href="index.php?action=event_list" id="attend_event-btn" class="btn btn-primary mr-3" >参加イベント</a>
                ...
                <li class="nav-item dropdown nav-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">                   
                        <a class="dropdown-item" href="index.php?action=my_page"><i class="fas fa-user mr-2"></i>マイページ</a>
                        <a class="dropdown-item" href="index.php?action=event_list" id="attend_event-drop"><i class=" fas fa-ticket-alt mr-2"></i>参加イベント</a>
                        <a class="dropdown-item" href="#" id="favourite_event-drop"><i class="fas fa-heart mr-2"></i>お気に入りイベント</a>
                        ...
                        <a class="dropdown-item" href="index.php?action=logout"><i class="fas fa-power-off mr-2"></i>ログアウト</a>
                    </div>
                </li>
            </ul>
        </div>
